...
<div class="headBanner">
    ...
    <button class="btn-gradient-3d-simple" onclick="location.href='top.php'">もどる</button>
    ...
    <button class="btn-gradient-3d-simple" onclick="location.href='quit.php'">退会</button>
</div>
...
<div class="menu">
    ...
    <button class="btn-gradient-3d-simple" onclick="location.href=''">履歴書</button>
    </div>
    <div class="menu2">
